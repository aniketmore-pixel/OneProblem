...
                        {/* ✅ Blog content - ADDED: prose-img:max-w-2xl prose-img:mx-auto to reduce internal image size */}
                        <div className="blog-content prose prose-lg lg:prose-xl max-w-none prose-img:max-w-2xl prose-img:mx-auto">
